...
# Explicitly telling Flask to look for index.html in the root folder instead of 'templates/'
...
def recommend_jobs(text):
    job_titles = {
        ...
        "Financial Analysis": ["Financial Analyst", "Investment Banker", "Accountant"],
...
if __name__ == '__main__':
    # Force the app onto port 7860 so Hugging Face can display it externally
